...
<?php $validation = \Config\Services::validation(); ?>
            ...
            <form action="<?=site_url('student/store')?>" method="post" id="student">
             
            <div class="form-group">
                <label for="name">Name:</label>
                <input type="text" class="form-control" name="name" value="<?= set_value('name') ?>"> 
                    <span class="fielderror margin_bottom <?php echo !empty($name) ? '' : 'none'; ?>" id="name">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="phone" value="<?= set_value('phone') ?>" > 
